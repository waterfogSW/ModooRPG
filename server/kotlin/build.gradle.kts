...
plugins {
    ...
    id(libs.plugins.java.test.fixtures.get().pluginId)
    id(libs.plugins.idea.get().pluginId)
...
allprojects {
    group = "com.waterfogsw.modoo-rpg"
...
subprojects {
    ...
    apply(plugin = rootProject.libs.plugins.java.test.fixtures.get().pluginId)
